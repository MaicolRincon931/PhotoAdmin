                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="/login">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Ingresa tu contraseña">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="/olvide">¿Olvidaste tu Contraseña? Recupérala Aquí</a>
                                    </div>
